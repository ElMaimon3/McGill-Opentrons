...
metadata = {
    'protocolName': 'Minipreps time measurement',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    protocol.comment("Simulating lysis buffer addition")
    protocol.pause("Time 1 start")
    ...
    protocol.pause("Time 1 end, time 2 start")
