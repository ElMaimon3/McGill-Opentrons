...
Up to 2 primer tubes go into slots A2, B2 if the tube rack.
...
The following setting correspond to the details of your PCR cycles:
- `denaturation_temp`
- `initial_denaturation_time_seconds`
- `denaturation_time_seconds`
- `annealing_temp`
- `annealing_time_seconds`
- `extension_temp`
- `extension_time_seconds`
- `final_extension_time_seconds`
- `num_cycles`

- `primers_loaded`: If each sample you're using requires a different primer, you must set this to True and add them by hand
- `colony_pcr`: Set this to True if you're doing colony PCR

The following settings refer to colony PCR:
- `lysis_temp`
- `lysis_time_seconds`